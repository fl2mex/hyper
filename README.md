...
| <ul><li>- [ ] Graphics Pipeline        | <ul><li>- [ ] Shader Setup            | <ul><li>- [ ] Buffer Setup                    | <ul><li>- [ ] Extras             |
|----------------------------------------|---------------------------------------|-----------------------------------------------|----------------------------------|
| <ul><li>- [x] Window Creation          | <ul><li>- [ ] Shader Compile          | <ul><li>- [ ] Framebuffer Setup               | <ul><li>- [ ] Texture Loading    |
| <ul><li>- [x] Instance Creation        | <ul><li>- [ ] Shader Object Creation  | <ul><li>- [ ] Command Buffer Setup            | <ul><li>- [ ] GLTF Loading       |
| <ul><li>- [x] Debug Messenger Creation | <ul><li>- [ ] Compute Shader Pipeline | <ul><li>- [ ] Vertex & Index Buffer Creation  | <ul><li>- [ ] Mesh System        |
